...
- Auto-generated descriptions for parameters without explicit descriptions
  - Common parameter names (`id`, `page`, `limit`, `offset`, `search`, `name`, `email`, etc.) get sensible default descriptions
  - Path parameters always get contextual descriptions based on their name
  - Pagination, search, and filtering parameters are automatically documented
